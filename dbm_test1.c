...
#define TEST_DB_FILE "/home/wuqiang/share/test_we/c_train/dbm1_database"
#define ITEMS_USED 3
...
int main(int argc, char *argv[])
{
	...
	memset(items_to_store,0x00,sizeof(items_to_store));
	...
	strcpy(items_to_store[2].more_chars,"bza");
	...
	for(i=0;i<ITEMS_USED;i++)
	{
		...
		//data_datum.dsize = sizeof(item_retrieved);
	...
	//check if checkout the data from db;
